...
class TriggerOverlayView(context: Context) : View(context) {

    var onPositionChanged: ((left: Int, top: Int) -> Unit)? = null
    var areaSize: Int = 100
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        canvas.drawRoundRect(0f, 0f, w, h, 8f, 8f, fillPaint)
        canvas.drawRoundRect(0f, 0f, w, h, 8f, 8f, borderPaint)
        canvas.drawText("扳机范围", w / 2f, h / 2f + 12f, textPaint)
    }
